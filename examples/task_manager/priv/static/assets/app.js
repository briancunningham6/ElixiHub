  ...
  var require_topbar = __commonJS({
    "vendor/topbar.js"(exports, module) {
      (function(window2, document2) {
        ...
        var canvas, currentProgress, showing, progressTimerId, fadeTimerId, delayTimerId;
        var options = {
          autoRun: true,
          barThickness: 3,
          barColors: {
            ...
            if (delay) {
              ...
              if (options.autoRun) {
                (function loop() {
                  ...
                  topbar2.progress("+" + 0.4 * Math.pow(1 - Math.sqrt(currentProgress), 2));
                })();
              }
            }
          },
        ...
        var addListeners = function() {
          ...
          if (window2.addEventListener) {
            window2.addEventListener("resize", resize, false);
          } else if (window2.attachEvent) {
            window2.attachEvent("onresize", resize);
          }
        };
